...
// APIKey holds API key for Google Places
var APIKey string
...
// Public is a method to implement Facade interface
// It returns data in a way we want it to be publicly
// viewed
...
// Query struct to represent and initiate query
type Query struct {
	Lat          float64
	Lng          float64
	Journey      []string
...
// Run is a method for finding places
